...
class _FoodPageBodyState extends State<FoodPageBody> {
  PageController pageController = PageController(
    viewportFraction:
        0.85, // set visibility of some portion of previous and next page/slide
  );
          ...
          return popularProducts.isLoaded
              ? Container(
                  ...
                  child: PageView.builder(
                      ...
                      itemCount:
                          popularProducts.popularProductList.length, // 0 to 4
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              margin: EdgeInsets.only(
                  left: Dimensions.width10,
                  right: Dimensions
                      .width10), // gives margin between different containers while horizontal scroll
              decoration: BoxDecoration(
